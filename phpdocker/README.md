...
You can access your application via **`localhost`**. mailpit and nginx both respond to any hostname, in case you want to
add your own hostname on your `/etc/hosts`

Service|Address outside containers
-------|--------------------------
Webserver|[localhost:5588](http://localhost:5588)
mailpit web interface|[localhost:5589](http://localhost:5589)
...
SMTP (mailpit)|mailpit|1025 (default)
